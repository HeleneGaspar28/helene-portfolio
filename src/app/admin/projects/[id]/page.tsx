...
export default async function EditProject({ params }: { params: { id: string } }) {
  ...
  if (!project) redirect("/admin/projects/new");
    ...
    <main className="container py-5" style={{ maxWidth: 720 }}>
      ...
      <form action={update} className="vstack gap-3">
        ...
        <div className="row g-3">
          <div className="col-md-6"><input name="githubUrl" className="form-control" defaultValue={project.githubUrl ?? ""} /></div>
          <div className="col-md-6"><input name="websiteUrl" className="form-control" defaultValue={project.websiteUrl ?? ""} /></div>
        </div>
